...
-	gzip -d <<filename>>
		...
		<<filename>> 	Name of compressed archive [phase.tar.gz]

-	sudo docker image load -i <<filename>>
	
		<<filename>>	Name of the image archive [phase.tar]

Example Usage: 
--------------

-	sudo docker run --rm -it --gpus all -v <<inputDir>>:/home/Workspace/data phase <<args>>
